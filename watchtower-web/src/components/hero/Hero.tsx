...
export default function Hero() {
  ...
  const handleLiveMap = () => {
    // Change this later to "/map" when we create the public map page.
    navigate("/admin/map");
  };
          ...
          <div className="relative z-10">
            ...
            <div className="mt-12 flex flex-wrap gap-5">
              <Button
                ...
                className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50"
              >
                Report Incident
              </Button>
